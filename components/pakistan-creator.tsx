          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4 text-center">
              <div className="font-inter">
                <div className="text-2xl font-bold text-pakistan-green dark:text-green-400">
                  14 August
                </div>
          ...
          <div className="h-full grid lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 h-full">
              <Card className="h-full p-6 bg-white/50 dark:bg-gray-800/50 border-green-200 dark:border-gray-600 flex flex-col">
                <CanvasFrame
                  ...
                  crescentStar={
                    graphicsState.crescentStarEnabled
                      ? graphicsState.crescentStar
                      : null
                  }
                  ...
                  skyline={
                    graphicsState.skylineEnabled ? graphicsState.skyline : null
                  }
                  confettiEnabled={graphicsState.confettiEnabled}
                  confettiDensity={graphicsState.confettiDensity}
                  timeline={
                    graphicsState.timelineEnabled
                      ? graphicsState.timeline
                      : null
                  }
                  qrCode={
                    graphicsState.qrCodeEnabled ? graphicsState.qrCode : null
                  }
                />
              </Card>
            </div>
            ...
            <div className="max-h-[80vh] overflow-y-auto">
              <div className="space-y-4">
                <Accordion
                  type="multiple"
                  defaultValue={["text", "graphics", "export"]}
                  className="space-y-2"
                >
                    ...
                    <AccordionContent>
                      <GraphicsControls
                        ...
                        onToggleCrescentStar={
                          graphicsState.setCrescentStarEnabled
                        }
                        ...
                        onUpdateConfettiDensity={
                          graphicsState.setConfettiDensity
                        }
                  ...
                  <AccordionItem value="export">
                    ...
                    <AccordionContent>
                      <ExportControls
                        canvasPreset={canvasState.canvasPreset}
                        canvasRef={canvasRef}
                      />
                    </AccordionContent>
                  </AccordionItem>
        ...
        <div className="container mx-auto px-4 py-3">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-4">
              ...
              {/* <Button
                size="sm"
                className="bg-pakistan-green hover:bg-green-700 text-white text-xs"
              >
                Share
              </Button> */}
            </div>
